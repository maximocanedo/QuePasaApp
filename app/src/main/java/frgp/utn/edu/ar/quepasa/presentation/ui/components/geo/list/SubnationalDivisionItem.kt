...
@Composable
fun SubnationalDivisionListItem(
    data: SubnationalDivision,
    modifier: Modifier,
    showGeographicalContext: Boolean = true,
    selectable: Boolean = false,
    selected: Boolean = false,
    onSelect: (SubnationalDivision, Boolean) -> Unit,
...
@Preview
@Composable
fun SubnationalDivisionListItemPreview() {
    val n = SubnationalDivision(
        label = "Buenos Aires",
        active = true,
